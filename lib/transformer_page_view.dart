...
class TransformerPageView extends StatefulWidget {
  ...
  TransformerPageView({
    ...
    required this.itemCount,
        ...
        this.duration = duration ?? new Duration(milliseconds: kDefaultTransactionDuration),
        super(key: key);
  ...
  static int? getRealIndexFromRenderIndex({required bool reverse, int? index, int? itemCount, required bool loop}) {
  ...
  static PageController createPageController(
      {required bool reverse, int? index, int? itemCount, required bool loop, required double viewportFraction}) {
